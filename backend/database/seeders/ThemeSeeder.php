    ...
    private function weddingThemes(): array
    {
        return [
            ...
            [
                'name' => 'Blue Botanical',
                'slug' => 'blue-botanical',
                'description' => 'Biru pastel lembut dengan ornamen floral & foto pasangan bulat',
                'config' => [
                    'ornament' => 'floral',
                    'reveal' => 'fade',
                    'radius' => '1.25rem',
                    ...
                    'tokens' => [
                        'bg' => '#eef5fb', 'bgAlt' => '#e3eef8', 'surface' => '#ffffff',
                        'primary' => '#2f5d8a', 'primaryFg' => '#ffffff', 'secondary' => '#7ea3c4',
                        'accent' => '#a9c4dd', 'text' => '#2b3a4a', 'muted' => '#6b8098', 'border' => '#d7e5f0',
                    ],
                    'swatch' => ['#eef5fb', '#d7e5f0', '#7ea3c4', '#2f5d8a'],
                    'texture' => 'radial-gradient(circle at 12% 8%, rgba(126,163,196,0.18), transparent 45%), radial-gradient(circle at 88% 85%, rgba(169,196,221,0.22), transparent 50%)',
                    // Extra key beyond the frontend's original InvitationTheme shape — renders
                    // PersonCard photos as round avatars instead of the default rectangle
                    // (see frontend/src/lib/themes.ts InvitationTheme.personCardStyle).
            ...
            [
                ...
                'description' => 'Ungu lavender lembut dengan buket mawar rimbun di setiap sudut',
                'config' => [
                    'ornament' => 'bouquet',
                    'reveal' => 'fade',
                    'radius' => '1rem',
                    ...
                    'tokens' => [
                        'bg' => '#f6f3f9', 'bgAlt' => '#ece4f3', 'surface' => '#ffffff',
                        'primary' => '#5b3a7e', 'primaryFg' => '#ffffff', 'secondary' => '#8a6bb0',
                        'accent' => '#c9b8e0', 'text' => '#3a2e46', 'muted' => '#8a7f97', 'border' => '#ddd3ea',
                    ],
                    'swatch' => ['#f6f3f9', '#ddd3ea', '#8a6bb0', '#5b3a7e'],
                    'texture' => 'radial-gradient(circle at 15% 12%, rgba(91,58,126,0.10), transparent 45%), radial-gradient(circle at 85% 88%, rgba(138,107,176,0.14), transparent 50%), radial-gradient(circle at 50% 50%, rgba(180,170,190,0.06), transparent 60%)',
                ],
            ],
    ...
    private function weddingDarkThemesClassic(): array
    {
        return [
            ...
            [
                'name' => 'Walimatul Ursy',
                'slug' => 'walimatul-ursy',
                'description' => 'Zamrud malam & emas islami dengan lengkung mihrab, bulan sabit, dan lentera bercahaya',
                'config' => [
                    'ornament' => 'crescent',
                    'reveal' => 'blur',
                    'radius' => '0.5rem',
                    // Same arch/mihrab card shape as Walimatul Khitan — see that theme's note
                    // in this same seeder for why (one Islamic theme family, light + dark).
                    ...
                    'tokens' => [
                        'bg' => '#0a1f16', 'bgAlt' => '#0f2a1e', 'surface' => '#12332a',
                        'primary' => '#d4af37', 'primaryFg' => '#0a1f16', 'secondary' => '#1f4a38',
                        'accent' => '#e7d08a', 'text' => '#f0ece2', 'muted' => '#8fa89a', 'border' => '#24473a',
                    ],
                    'swatch' => ['#0a1f16', '#1f4a38', '#d4af37', '#e7d08a'],
                    'texture' => 'radial-gradient(circle at 50% -10%, rgba(212,175,55,0.15), transparent 55%), radial-gradient(circle at 10% 90%, rgba(15,81,50,0.5), transparent 55%)',
                ],
                'supports_dark_mode' => true,
            ],
            [
    ...
    private function khitanThemes(): array
    {
        return [
            ...
            [
                ...
                'slug' => 'walimatul-khitan',
                'description' => 'Zamrud & emas islami dengan bulan sabit, bintang, dan lengkung mihrab',
                'config' => [
                    'ornament' => 'crescent',
                    'reveal' => 'fade',
                    'radius' => '0.75rem',
                    // Rounded top, flat bottom — an arch/mihrab silhouette on every card
                    // (see ArchWatermark in frontend/src/components/invitation/ornaments.tsx).
                    'cardRadius' => '3rem 3rem 1rem 1rem',
                    ...
                    'tokens' => [
                        'bg' => '#faf5e6', 'bgAlt' => '#f2ead2', 'surface' => '#ffffff',
                        'primary' => '#0f5132', 'primaryFg' => '#fdf6e3', 'secondary' => '#b08d57',
                        'accent' => '#d4af37', 'text' => '#1c2b22', 'muted' => '#6b7d70', 'border' => '#e6d9b0',
                    ],
                    'swatch' => ['#faf5e6', '#e6d9b0', '#b08d57', '#0f5132'],
                    'texture' => 'radial-gradient(circle at 15% 10%, rgba(212,175,55,0.14), transparent 42%), radial-gradient(circle at 85% 85%, rgba(15,81,50,0.10), transparent 48%)',
                ],
            ],
            [
                'name' => 'Khitanan Islami Elegan',
                'slug' => 'khitanan-islami-elegan',
                'description' => 'Template undangan khitanan bernuansa Islami dengan desain elegan, floral, dan aksen emas.',
                'config' => [
                    // Reuses the "bouquet" rose/leaf corner cluster (see Lavender Bouquet)
                    // recolored cream/gold/sage — cream dominates, gold is the accent,
                    // green is only a soft touch, per this theme's requested color hierarchy.
                    'ornament' => 'bouquet',
                    'reveal' => 'fade',
                    'radius' => '1rem',
                    // Same mihrab/arch card silhouette as Walimatul Khitan/Ursy, so this
                    // reads as the same Islamic theme family despite leaning floral.
                    'cardRadius' => '3rem 3rem 1rem 1rem',
                    ...
                    'tokens' => [
                        'bg' => '#fdfaf4', 'bgAlt' => '#f6efe0', 'surface' => '#ffffff',
                        'primary' => '#a9762d', 'primaryFg' => '#fffaf0', 'secondary' => '#6b8f71',
                        'accent' => '#d4af37', 'text' => '#3a2f22', 'muted' => '#8a7c68', 'border' => '#e8dcc0',
                    ],
                    'swatch' => ['#fdfaf4', '#e8dcc0', '#6b8f71', '#a9762d'],
                    'texture' => 'radial-gradient(circle at 15% 10%, rgba(212,175,55,0.12), transparent 45%), radial-gradient(circle at 85% 85%, rgba(107,143,113,0.10), transparent 48%)',
                    // Extra key beyond the frontend's original InvitationTheme shape — round
                    // photo frame for the child's portrait (see frontend/src/lib/themes.ts
                    // InvitationTheme.personCardStyle).
                    'personCardStyle' => 'circle',
                ],
            ],
            [
                'name' => 'Tasyakuran Khitan',
                'slug' => 'tasyakuran-khitan',
                'description' => 'Islami hangat dengan bunga magnolia asli & ilustrasi masjid — krem, emas, dan hijau zamrud.',
                'config' => [
                    // "bouquet" reuses every existing corner-placement rule already proven for
                    // Lavender Bouquet/Khitanan Islami Elegan — CornerOrnament swaps in this
                    // theme's own cropped photo instead of the SVG rose cluster (see
                    // RASTER_CORNER_ORNAMENTS in frontend/src/components/invitation/ornaments.tsx).
                    'ornament' => 'bouquet',
                    'reveal' => 'fade',
                    'radius' => '1rem',
                    // Plain soft-rounded cards, not the mihrab arch used by the other Islamic
                    // themes — the reference this theme is drawn from uses simple rounded cards.
                    'cardRadius' => '1.25rem',
                    ...
                    'tokens' => [
                        'bg' => '#fbf6e9', 'bgAlt' => '#f5ecd6', 'surface' => '#ffffff',
                        'primary' => '#b8862f', 'primaryFg' => '#fffaf0', 'secondary' => '#1f5c3f',
                        'accent' => '#d4af37', 'text' => '#1c3327', 'muted' => '#7c8a7e', 'border' => '#e8dfc0',
                    ],
                    'swatch' => ['#fbf6e9', '#e8dfc0', '#1f5c3f', '#b8862f'],
                    'texture' => 'radial-gradient(circle at 15% 10%, rgba(212,175,55,0.10), transparent 45%), radial-gradient(circle at 85% 85%, rgba(31,92,63,0.08), transparent 48%)',
                    'personCardStyle' => 'circle',
                ],
            ],
        ];
