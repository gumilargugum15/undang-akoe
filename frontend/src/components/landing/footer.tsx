    ...
    <footer id="footer" className="border-t bg-background py-14">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="grid gap-10 sm:grid-cols-3">
          <div>
            ...
            <div className="mt-4 flex gap-3 text-muted-foreground">
              <span aria-label="Instagram (segera hadir)" title="Segera hadir" className="cursor-default opacity-50">
                <Instagram className="size-5" />
              </span>
              <span aria-label="Facebook (segera hadir)" title="Segera hadir" className="cursor-default opacity-50">
                <Facebook className="size-5" />
              </span>
              <a href="mailto:halo@undangakoe.test" aria-label="Email" className="hover:text-foreground">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2">
              {FOOTER_NAV.map((link) => (
                <li key={link.href}>
                  <a href={link.href} className="font-landing-sans text-sm text-muted-foreground hover:text-foreground">
                    {link.label}
                  </a>
                </li>
              ))}
        ...
        <div className="mt-10 flex flex-col items-center justify-between gap-4 border-t pt-6 font-landing-sans text-xs text-muted-foreground sm:flex-row">
          <p>© {year} Undangan Digital. Seluruh hak cipta dilindungi.</p>
